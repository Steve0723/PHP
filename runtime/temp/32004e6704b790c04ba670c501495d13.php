<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"F:\xmapp\htdocs\gdhb1.com\public/../application/admin\view\login\login.html";i:1530629754;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
            ...
            methods:{
                ...
                loginSubmit:function(){
                    ...
                    axios.post('<?php echo url("admin/Login/doLogin"); ?>',postData).then(function(da){
                        ...
                        o.vcodeURL="<?php echo url('admin/Tool/vcode'); ?>?"+Math.random();
                        //判断登陆状态 如果状态为2登陆成功
                        if(da.data.status==2){
